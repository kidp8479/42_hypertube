...
Use the library, not hand-written JSON. `SKILL_DIR` is the directory
holding this `SKILL.md` (`~/.claude/skills/excalidraw-diagrams` for a
personal install, `<repo>/.claude/skills/excalidraw-diagrams` for a
project one):
