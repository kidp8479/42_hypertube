// Composition root: env validation, DB connection, global guards/throttling,
...
@Module({
  ...
  // Guard order = declaration order: an unauthenticated flooder is
  // rate-limited before the token check even runs.
  providers: [
    AppService,
